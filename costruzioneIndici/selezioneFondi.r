...
## filtra i fondi
CTA_sub_Filtrati <- filterFunds(CTA_sub.l,CTA_sub_Stat.df,MaxDrawdownPerc=15,NbObs=24,AnnualizedMean=0.02,AnnualizedStdev=12,AUM.mio=100,strategia="CTA",
