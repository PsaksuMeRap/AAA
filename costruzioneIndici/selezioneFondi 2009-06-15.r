...
setwd("/home/claudio/XP/analisi serie storiche/")
source("/home/claudio/XP/analisi serie storiche/analisiSerieStoriche__A.r")
source("/home/claudio/XP/analisi serie storiche/capitalgest/importazione.r")
source("/home/claudio/XP/analisi serie storiche/capitalgest/selezioneFondiCodice.r")
source("/home/claudio/XP/analisi serie storiche/capitalgest/costruzioneIndiceStorico.r")
...
quantile(computedStatistics[[2]]["Annualized stdev"][,1],seq(0.1,0.7,by=0.1)) 
...
## filtra i fondi
CTA_sub_Filtrati <- filterFunds(CTA_sub.l,CTA_sub_Stat.df,MaxDrawdownPerc=15,NbObs=24,AnnualizedMean=0.02,AnnualizedStdev=12,AUM.mio=100,strategia="CTA",desiredNbFunds="all",startDate=-36,indexWeight=0.2,selectionStrategy=c("Annualized mean") )
...
## filtra i fondi
ELS_sub_Filtrati <- filterFunds(ELS_sub.l,ELS_sub_Stat.df,MaxDrawdownPerc=15,NbObs=24,AnnualizedMean=0.02,AnnualizedStdev=6,AUM.mio=100,strategia="ELS",
...
write.csv(MAC_sub_filtrati_matrix,".csv")
write.csv(ELS_sub_filtrati_matrix,".csv")
write.csv(CTA_sub_filtrati_matrix,".csv")
