...
source("./base/lib/classDefinitions/LongTermRatingSP/LongTermRatingSP.R")
...
source("./base/lib/classDefinitions/LongTermRatingSP/operators.R")
source("./base/lib/classDefinitions/LongTermRatingMoody/operators.R")

source("./base/lib/classDefinitions/Security/Security.R")
source("./base/lib/classDefinitions/Security/Basket_certificate.R")
source("./base/lib/classDefinitions/Security/Bond.R")
source("./base/lib/classDefinitions/Security/Bond_floater.R")
source("./base/lib/classDefinitions/Security/Certificate.R")
...
source("./base/lib/classDefinitions/Security/Opzioni_su_obbligazioni.R")
...
source("./base/lib/methods/explodeFundFixedIncome/explodeFundFixedIncome.R")
source("./base/lib/methods/explodeAndReplaceFundFixedIncome/explodeAndReplaceFundFixedIncome.R")
