...
advisors[["Ponti"]]   <- new("Advisor",name="Gabriele Ponti", shortName="Ponti",email="gabriele.ponti@agendainvest.com")
# advisors[["Ortelli1"]] <- new("Advisor",name="Ortelli Claudio", shortName="Ortelli1",email="claudio.ortelli@opencapital.ch")
advisors[["Riskmanager"]] <- new("Advisor",name="Ortelli Claudio", shortName="Riskmanager",email="claudio.ortelli@gmail.com")
