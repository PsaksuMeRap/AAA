## uncomment to debug 
rm(list=ls(all=TRUE))
setwd("M:/workspace/AAA/ottimizzatore/r-output")
load("\\\\usi\\dfs\\utenti\\O\\ortellic\\Desktop\\excel_input.RData")
#load("C:\\R\\r-output\\excel_input.RData")
rSourceDirectory = "M:/workspace/AAA/ottimizzatore/lib/"
rOutputdirectory = "M:/workspace/AAA/ottimizzatore/r-output"
