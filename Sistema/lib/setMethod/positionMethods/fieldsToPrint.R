...
## this function returns, for each position, the fields that
## must be printed 

## define the fieldsToPrint generic method
fun <- function(x,width) standardGeneric("fieldsToPrint")
setGeneric("fieldsToPrint",fun)
...
fun <- function(x,width) {
	...
	fields$currency <- as.character(x@money@currency)
