...
source("./lib/classDefinitions/AyrtonSecurity/AyrtonSecurity.R")
...
source("./lib/classDefinitions/Security/ETF_commodities.R")
source("./lib/classDefinitions/Security/Depositi_a_termine.R")
...
source("./lib/classDefinitions/FundDB/FundDB.R")
source("./lib/classDefinitions/FundRecord/FundRecord.R")
...
source("./lib/classDefinitions/Position/PositionFondiObbligazionariOC/PositionFondiObbligazionariOC.R")
source("./lib/classDefinitions/Positions/Positions.R")
source("./lib/classDefinitions/Portfolio/Portfolio.R")
source("./lib/classDefinitions/Portfolios/Portfolios.R")
...
source("./lib/setMethod/positionsFactory/completePositionWithAccruedInterest.R")
source("./lib/setMethod/positionsFactory/matchPositionToAyrtonPosition.R")
...
source("./lib/identifyPositionsToExplode.R")
source("./lib/setMethod/testSuiteFactory/testSuiteFactory.R")
source("./lib/setMethod/applyTestSuite/applyTestSuite.R")
source("./lib/explodePortfolioByFund.R")
