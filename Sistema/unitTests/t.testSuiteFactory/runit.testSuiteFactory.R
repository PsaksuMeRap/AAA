...
test.shouldCreateTestSuiteCollection <- function() {
	...
	checkEquals(testSuiteCollection@testSuitesParsed[[2]]@directory,"./unitTests/data/testSuites/test2")
	checkEquals(testSuiteCollection@testSuitesParsed[[3]]@directory,"./unitTests/data/testSuites/test2")
	checkEquals(testSuiteCollection@testSuitesParsed[[5]]@directory,"./unitTests/data/testSuites/test3")
